  ...
  return (
    <MenuWrapper showOnMobile={false}>
      <div className="flex items-center justify-between gap-2 sm:gap-4 rounded-full py-1 px-3 sm:px-4 text-neutral-600 dark:text-neutral-400">
        ...
        <LinkWrapper href="https://www.notion.so/anuj-s-Projects-1a19f5253d278085ab14fdb7d9f63c13" label="notion">
        <NotionIcon />  
        </LinkWrapper>
        <BottomStaticGlare />
      </div>
...
function NotionIcon() {
  return (
    <svg 
    className={clsx(
      "size-5 text-neutral-600 dark:text-neutral-400 group-hover:text-neutral-950 dark:group-hover:text-neutral-50 transition-all duration-150 pointer-events-none",
